...
public class SysUserServiceImpl implements SysUserService {
	...
	public SysUserEntity queryObject(Long id) {
		SysUserEntity entity = sysUserDao.queryObject(id);
		if (entity != null && entity.getType() != null && this.typeService.queryObject(entity.getType()) != null)
			entity.setTypeEntity(this.typeService.queryObject(entity.getType()));
		return entity;
	}

	@Override
	public SysUserEntity mqueryObject(Long userId) {
